            ...
            if (count _sPos > 1 && {_distance < 15}) then {
                _text = switch (true) do {
                    ...
                    case (side _x isEqualTo west && {!isNil {_x getVariable "rank"}}): {format["<img image='%1' size='1'></img> %2<br/><t color='#42b6f4'>%3</t>",switch ((_x getVariable "rank")) do {
                        ...
                        case 5: {"icons\rank6.paa"};
                        case 6: {"icons\rank5.paa"};
                        case 7: {"icons\rank4.paa"};
                        case 8: {"icons\rank3.paa"};
                        case 9: {"icons\rank2.paa"};
                        case 10: {"icons\rank1.paa"};
                        default {"icons\rank10.paa"};
                        },_x getVariable ["realname",name _x],
						switch ((_x getVariable "rank")) do {
                        case 2: {"Polisinspektör"};
                        case 3: {"Poliskommisarie"};
                        case 4: {"Polisintendent 2"};
