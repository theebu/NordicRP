...
[Player, _bad, _time] remoteExecCall [ "HC_fnc_jailSys" , HC_Life]; // Here was only _time Added
} else {
[Player, _bad, _time] remoteExecCall [ "life_fnc_jailSys" , RSERV]; // Here was only _time Added
};
