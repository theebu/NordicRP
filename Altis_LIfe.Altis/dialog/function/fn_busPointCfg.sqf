...
*/
private["_side","_return","_busCfg","_curConfig","_name","_licenses","_level","_levelName","_levelValue","_levelType","_tempConfig","_flag"];
...
_busCfg = missionConfigFile >> "BusCfgSpawnPoints" >> _side;

for "_i" from 0 to count(_busCfg)-1 do {
    _flag = true;
    _tempConfig = [];
        _curConfig = (_busCfg select _i);
