...
class BusCfgSpawnPoints {
    class Civilian {
        class Kavala {
            displayName = "Kavala Bus Stop";
            spawnMarker = "kavala_bus";
        ...
        class Athira {
            displayName = "Athira Bus Stop";
            spawnMarker = "athira_bus";
            icon = "\a3\ui_f\data\map\MapControl\busstop_ca.paa";
            licenses[] = { { "", true } };
            level[] = { "", "", -1 };
        };
        ...
        class Pyrgos {
            displayName = "Pyrgos Bus Stop";
            spawnMarker = "pygros_bus";
            icon = "\a3\ui_f\data\map\MapControl\busstop_ca.paa";
            licenses[] = { { "", true } };
            level[] = { "", "", -1 };
        };
        ...
        class Sofia {
            displayName = "Sofia Bus Stop";
            spawnMarker = "sofia_bus";
            icon = "\a3\ui_f\data\map\MapControl\busstop_ca.paa";
            licenses[] = { { "", true } };
            level[] = { "", "", -1 };
        };
